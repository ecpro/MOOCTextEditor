...
public class NearbyWords implements SpellingSuggest {
	...
	public static void main(String[] args) {
		...
		NearbyWords nbw = new NearbyWords(dict);
		System.out.println(nbw.suggestions("kangaroa", 6));
		// nbw.insertions("spell", new ArrayList<String>(), true);
		// nbw.deletions("spell", new ArrayList<String>(), true);
		/*
