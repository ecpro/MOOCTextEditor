...
public class DocumentBenchmarking {
	...
	public static void main(String[] args) {
		...
		System.out.format("%-15s\t%20s\t%20s\n", "NumberOfChars", "Basic Document", "Efficient Document");
		...
		for (int numToCheck = start; numToCheck < numSteps * increment + start; numToCheck += increment) {
			 ...
			 */
			String stringFromFile = DocumentBenchmarking.getStringFromFile(textfile, numToCheck);
			...
			for (int i = 0; i < trials; i++) {
				...
				BasicDocument doc = new BasicDocument(stringFromFile);
				doc.getFleschScore();

				long stopTime = System.nanoTime();

				double currentTime = (double) (stopTime - startTime) / 1000000000;
			...
			for (int i = 0; i < trials; i++) {
				...
				EfficientDocument doc = new EfficientDocument(stringFromFile);
				doc.getFleschScore();
			...
			System.out.format("%13d\t%20f\t%20f\n", numToCheck, bTime,eTime);
		}
